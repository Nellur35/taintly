...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("gitlab/vulnerable/ai_llm_output_to_shell.yml",         ["AI-GL-002"], ["AI-GL-007", "SEC10-GL-002"]),
        ("gitlab/vulnerable/ai_joblib_load.yml",                 ["AI-GL-003"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/ai_hf_no_revision.yml",              ["AI-GL-004"], ["AI-GL-006", "SEC10-GL-002"]),
        ("gitlab/vulnerable/ai_torch_load_unsafe.yml",           ["AI-GL-005"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/ai_no_model_scanner.yml",            ["AI-GL-006"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/ai_prompt_injection_surface.yml",    ["AI-GL-007"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/ai_agent_cli_on_mr.yml",             ["AI-GL-008"], ["LOTP-GL-001", "LOTP-GL-003", "SEC10-GL-002"]),
        ("gitlab/vulnerable/debug_trace.yml",                    ["SEC7-GL-001"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/prod_no_approval.yml",               ["SEC1-GL-001"], ["SEC10-GL-002", "SEC5-GL-001"]),
        ("gitlab/vulnerable/security_gate_allow_failure.yml",    ["SEC1-GL-002"], ["SEC10-GL-002"]),
        ...
        ("gitlab/vulnerable/deploy_no_resource_group.yml",       ["SEC5-GL-001"], ["SEC1-GL-001", "SEC10-GL-002"]),
        ("gitlab/vulnerable/wget_pipe_bash.yml",                 ["SEC6-GL-006"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/long_lived_cloud_creds.yml",         ["SEC6-GL-007"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/registry_override.yml",              ["SEC6-GL-008"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/service_latest.yml",                 ["SEC8-GL-003"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/artifacts_no_access.yml",            ["SEC9-GL-001"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/download_no_checksum.yml",           ["SEC9-GL-002"], ["AI-GL-006", "SEC10-GL-002"]),
        ("gitlab/vulnerable/cache_no_key.yml",                   ["SEC9-GL-003"], ["SEC10-GL-002"]),
        ("gitlab/vulnerable/print_job_token.yml",                ["SEC10-GL-001"], ["SEC10-GL-002"]),
        # ── Jenkins ─────────────────────────────────────────────────────────────
