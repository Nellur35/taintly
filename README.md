...
<!-- AUTOGEN:summary -->
303 file-based rules and 32 platform-posture checks across GitHub Actions, GitLab CI, and Jenkins. Includes a dedicated AI / ML category for workflows that load models or run AI coding agents.
<!-- /AUTOGEN:summary -->
...
| SEC-4 — Poisoned Pipeline Execution | 30 | 10 | 11 |
| SEC-5 — Insufficient PBAC | 3 | 1 | 2 |
| SEC-6 — Insufficient Credential Hygiene | 12 | 9 | 10 |
...
| AI / ML | 39 | 16 | 12 |
| TAINT — Multi-stage taint flows | 19 | 9 | 2 |
<!-- /AUTOGEN:coverage -->
