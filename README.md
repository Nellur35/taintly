...
<!-- AUTOGEN:summary -->
316 file-based rules and 32 platform-posture checks across GitHub Actions, GitLab CI, Jenkins, and AWS CodeBuild. Includes a dedicated AI / ML category for workflows that load models or run AI coding agents.
<!-- /AUTOGEN:summary -->
...
| SEC-4 — Poisoned Pipeline Execution | 71 | 30 | 24 | 2 |
