...
from taintly.models import SequencePattern, Platform, RegexPattern, Rule, Severity
...
RULES: list[Rule] = [
    ...
    # =========================================================================
    # SEC8-GL-002 was a near-perfect duplicate of SEC3-GL-002 (same
    # SequencePattern, same severity, same remediation in spirit). Both
